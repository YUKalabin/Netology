...
### 9. В каком случае оператор вправе продолжить обработку ПДн даже при отзыве согласия на обработку ПДн со стороны субъекта ПДн?
   ...
   ### Изначально хотел ограничиться ссылками на статьи и прочтением их, но вспомнив предыдущее ДЗ, и мою попытку сократить количество копипасты, решил всё вставить сюда. 
   ...
   ## Задача №2 - Процедура имеет значение (обнаружил небольшую ошибку в вопросе задания в слове "зрения")
